...
Ищем закупки по 44-ФЗ и 223-ФЗ сразу по нескольким площадкам (ЕИС, Портал \
поставщиков) — как в Тендерплане и Контуре, остальные площадки добавляем по мере готовности.
