...
Тарифы:
• Старт — 4 900 ₽/мес, 5 товаров для сверки
• Бизнес — 12 900 ₽/мес, до 25 товаров, приоритетная поддержка
• Корпоративный — от 26 900 ₽/мес, безлимит + API + персональный менеджер
