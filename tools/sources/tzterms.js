...
// Из множества терминов оставить самые информативные. Длина — грубая, но честная
// мера специфичности: «нитриловые», «≥16 мм» несут больше, чем «года» или «шт».
function topTerms(set, limit) {
  return [...set].sort((a, b) => b.length - a.length || a.localeCompare(b)).slice(0, limit);
}
